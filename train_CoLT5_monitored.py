...
checkpoint_dir = './checkpoints_batch32'
...
# ============================
# 5. Initialize TensorBoard SummaryWriter
# ============================

from torch.utils.tensorboard import SummaryWriter
from datetime import datetime

# Define the log directory with a timestamp
log_dir = os.path.join('runs', 'colt5_triviaqa', datetime.now().strftime('%Y%m%d-%H%M%S'))

# Initialize the SummaryWriter
writer = SummaryWriter(log_dir=log_dir)

# ============================
# 6. Training Loop with Validation and Loss Tracking
# ============================
